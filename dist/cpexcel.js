...
var  utf_high_byte = 0xFFFD;
const common_chars = "\u0000\u0001\u0002\u0003\u0004\u0005\u0006\u0007\b\t\n\u000b\f\r\u000e\u000f\u0010\u0011\u0012\u0013\u0014\u0015\u0016\u0017\u0018\u0019\u001a\u001b\u001c\u001d\u001e\u001f !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
cptable[437] = (function(){ var d = common_chars + "ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜ¢£¥₧ƒáíóúñÑªº¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ", D = [], e = {}; for(var i=0; i!=d.length; ++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[620] = (function(){ var d = common_chars + "ÇüéâäàąçêëèïîćÄĄĘęłôöĆûùŚÖÜ¢Ł¥śƒŹŻóÓńŃźż¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[737] = (function(){ var d = common_chars + "ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩαβγδεζηθικλμνξοπρσςτυφχψ░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀ωάέήϊίόύϋώΆΈΉΊΌΎΏ±≥≤ΪΫ÷≈°∙·√ⁿ²■ ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[850] = (function(){ var d = common_chars + "ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø×ƒáíóúñÑªº¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ðÐÊËÈıÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµþÞÚÛÙýÝ¯´­±‗¾¶§÷¸°¨·¹³²■ ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[852] = (function(){ var d = common_chars + "ÇüéâäůćçłëŐőîŹÄĆÉĹĺôöĽľŚśÖÜŤťŁ×čáíóúĄąŽžĘę¬źČş«»░▒▓│┤ÁÂĚŞ╣║╗╝Żż┐└┴┬├─┼Ăă╚╔╩╦╠═╬¤đĐĎËďŇÍÎě┘┌█▄ŢŮ▀ÓßÔŃńňŠšŔÚŕŰýÝţ´­˝˛ˇ˘§÷¸°¨˙űŘř■ ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[857] = (function(){ var d = common_chars + "ÇüéâäàåçêëèïîıÄÅÉæÆôöòûùİÖÜø£ØŞşáíóúñÑĞğ¿®¬½¼¡«»░▒▓│┤ÁÂÀ©╣║╗╝¢¥┐└┴┬├─┼ãÃ╚╔╩╦╠═╬¤ºªÊËÈ�ÍÎÏ┘┌█▄¦Ì▀ÓßÔÒõÕµ�×ÚÛÙìÿ¯´­±�¾¶§÷¸°¨·¹³²■ ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[861] = (function(){ var d = common_chars + "ÇüéâäàåçêëèÐðÞÄÅÉæÆôöþûÝýÖÜø£Ø₧ƒáíóúÁÍÓÚ¿⌐¬½¼¡«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[865] = (function(){ var d = common_chars + "ÇüéâäàåçêëèïîìÄÅÉæÆôöòûùÿÖÜø£Ø₧ƒáíóúñÑªº¿⌐¬½¼¡«¤░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[866] = (function(){ var d = common_chars + "АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмноп░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀рстуфхцчшщъыьэюяЁёЄєЇїЎў°∙·√№¤■ ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[874] = (function(){ var d = common_chars + "€����…�����������‘’“”•–—�������� กขฃคฅฆงจฉชซฌญฎฏฐฑฒณดตถทธนบปผฝพฟภมยรฤลฦวศษสหฬอฮฯะัาำิีึืฺุู����฿เแโใไๅๆ็่้๊๋์ํ๎๏๐๑๒๓๔๕๖๗๘๙๚๛����", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[895] = (function(){ var d = common_chars + "ČüéďäĎŤčěĚĹÍľǪÄÁÉžŽôöÓůÚýÖÜŠĽÝŘťáíóúňŇŮÔšřŕŔ¼§«»░▒▓│┤╡╢╖╕╣║╗╝╜╛┐└┴┬├─┼╞╟╚╔╩╦╠═╬╧╨╤╥╙╘╒╓╫╪┘┌█▄▌▐▀αßΓπΣσµτΦΘΩδ∞φε∩≡±≥≤⌠⌡÷≈°∙·√ⁿ²■ ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[932] = (function(){ var d = [], e = {}, D = [], j;
D[0] = common_chars + "���������������������������������｡｢｣､･ｦｧｨｩｪｫｬｭｮｯｰｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝﾞﾟ��������������������������������".split("");
for(j = 0; j != D[0].length; ++j) if(D[0][j].charCodeAt(0) !== utf_high_byte) { e[D[0][j]] = 0 + j; d[0 + j] = D[0][j];}
D[129] = "����������������������������������������������������������������　、。，．・：；？！゛゜´｀¨＾￣＿ヽヾゝゞ〃仝々〆〇ー―‐／＼～∥｜…‥‘’“”（）〔〕［］｛｝〈〉《》「」『』【】＋－±×�÷＝≠＜＞≦≧∞∴♂♀°′″℃￥＄￠￡％＃＆＊＠§☆★○●◎◇◆□■△▲▽▼※〒→←↑↓〓�����������∈∋⊆⊇⊂⊃∪∩��������∧∨￢⇒⇔∀∃�����������∠⊥⌒∂∇≡≒≪≫√∽∝∵∫∬�������Å‰♯♭♪†‡¶����◯���".split("");
for(j = 0; j != D[129].length; ++j) if(D[129][j].charCodeAt(0) !== utf_high_byte) { e[D[129][j]] = 33024 + j; d[33024 + j] = D[129][j];}
...
for(j = 0; j != D[130].length; ++j) if(D[130][j].charCodeAt(0) !== utf_high_byte) { e[D[130][j]] = 33280 + j; d[33280 + j] = D[130][j];}
...
for(j = 0; j != D[131].length; ++j) if(D[131][j].charCodeAt(0) !== utf_high_byte) { e[D[131][j]] = 33536 + j; d[33536 + j] = D[131][j];}
D[132] = "����������������������������������������������������������������АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ���������������абвгдеёжзийклмн�опрстуфхцчшщъыьэюя�������������─│┌┐┘└├┬┤┴┼━┃┏┓┛┗┣┳┫┻╋┠┯┨┷┿┝┰┥┸╂�����������������������������������������������������������������".split("");
for(j = 0; j != D[132].length; ++j) if(D[132][j].charCodeAt(0) !== utf_high_byte) { e[D[132][j]] = 33792 + j; d[33792 + j] = D[132][j];}
D[135] = "����������������������������������������������������������������①②③④⑤⑥⑦⑧⑨⑩⑪⑫⑬⑭⑮⑯⑰⑱⑲⑳ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩ�㍉㌔㌢㍍㌘㌧㌃㌶㍑㍗㌍㌦㌣㌫㍊㌻㎜㎝㎞㎎㎏㏄㎡��������㍻�〝〟№㏍℡㊤㊥㊦㊧㊨㈱㈲㈹㍾㍽㍼≒≡∫∮∑√⊥∠∟⊿∵∩∪���������������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[135].length; ++j) if(D[135][j].charCodeAt(0) !== utf_high_byte) { e[D[135][j]] = 34560 + j; d[34560 + j] = D[135][j];}
D[136] = "���������������������������������������������������������������������������������������������������������������������������������������������������������������亜唖娃阿哀愛挨姶逢葵茜穐悪握渥旭葦芦鯵梓圧斡扱宛姐虻飴絢綾鮎或粟袷安庵按暗案闇鞍杏以伊位依偉囲夷委威尉惟意慰易椅為畏異移維緯胃萎衣謂違遺医井亥域育郁磯一壱溢逸稲茨芋鰯允印咽員因姻引飲淫胤蔭���".split("");
for(j = 0; j != D[136].length; ++j) if(D[136][j].charCodeAt(0) !== utf_high_byte) { e[D[136][j]] = 34816 + j; d[34816 + j] = D[136][j];}
...
for(j = 0; j != D[137].length; ++j) if(D[137][j].charCodeAt(0) !== utf_high_byte) { e[D[137][j]] = 35072 + j; d[35072 + j] = D[137][j];}
...
for(j = 0; j != D[138].length; ++j) if(D[138][j].charCodeAt(0) !== utf_high_byte) { e[D[138][j]] = 35328 + j; d[35328 + j] = D[138][j];}
...
for(j = 0; j != D[139].length; ++j) if(D[139][j].charCodeAt(0) !== utf_high_byte) { e[D[139][j]] = 35584 + j; d[35584 + j] = D[139][j];}
...
for(j = 0; j != D[140].length; ++j) if(D[140][j].charCodeAt(0) !== utf_high_byte) { e[D[140][j]] = 35840 + j; d[35840 + j] = D[140][j];}
...
for(j = 0; j != D[141].length; ++j) if(D[141][j].charCodeAt(0) !== utf_high_byte) { e[D[141][j]] = 36096 + j; d[36096 + j] = D[141][j];}
...
for(j = 0; j != D[142].length; ++j) if(D[142][j].charCodeAt(0) !== utf_high_byte) { e[D[142][j]] = 36352 + j; d[36352 + j] = D[142][j];}
...
for(j = 0; j != D[143].length; ++j) if(D[143][j].charCodeAt(0) !== utf_high_byte) { e[D[143][j]] = 36608 + j; d[36608 + j] = D[143][j];}
...
for(j = 0; j != D[144].length; ++j) if(D[144][j].charCodeAt(0) !== utf_high_byte) { e[D[144][j]] = 36864 + j; d[36864 + j] = D[144][j];}
...
for(j = 0; j != D[145].length; ++j) if(D[145][j].charCodeAt(0) !== utf_high_byte) { e[D[145][j]] = 37120 + j; d[37120 + j] = D[145][j];}
...
for(j = 0; j != D[146].length; ++j) if(D[146][j].charCodeAt(0) !== utf_high_byte) { e[D[146][j]] = 37376 + j; d[37376 + j] = D[146][j];}
...
for(j = 0; j != D[147].length; ++j) if(D[147][j].charCodeAt(0) !== utf_high_byte) { e[D[147][j]] = 37632 + j; d[37632 + j] = D[147][j];}
...
for(j = 0; j != D[148].length; ++j) if(D[148][j].charCodeAt(0) !== utf_high_byte) { e[D[148][j]] = 37888 + j; d[37888 + j] = D[148][j];}
...
for(j = 0; j != D[149].length; ++j) if(D[149][j].charCodeAt(0) !== utf_high_byte) { e[D[149][j]] = 38144 + j; d[38144 + j] = D[149][j];}
...
for(j = 0; j != D[150].length; ++j) if(D[150][j].charCodeAt(0) !== utf_high_byte) { e[D[150][j]] = 38400 + j; d[38400 + j] = D[150][j];}
...
for(j = 0; j != D[151].length; ++j) if(D[151][j].charCodeAt(0) !== utf_high_byte) { e[D[151][j]] = 38656 + j; d[38656 + j] = D[151][j];}
...
for(j = 0; j != D[152].length; ++j) if(D[152][j].charCodeAt(0) !== utf_high_byte) { e[D[152][j]] = 38912 + j; d[38912 + j] = D[152][j];}
...
for(j = 0; j != D[153].length; ++j) if(D[153][j].charCodeAt(0) !== utf_high_byte) { e[D[153][j]] = 39168 + j; d[39168 + j] = D[153][j];}
...
for(j = 0; j != D[154].length; ++j) if(D[154][j].charCodeAt(0) !== utf_high_byte) { e[D[154][j]] = 39424 + j; d[39424 + j] = D[154][j];}
...
for(j = 0; j != D[155].length; ++j) if(D[155][j].charCodeAt(0) !== utf_high_byte) { e[D[155][j]] = 39680 + j; d[39680 + j] = D[155][j];}
...
for(j = 0; j != D[156].length; ++j) if(D[156][j].charCodeAt(0) !== utf_high_byte) { e[D[156][j]] = 39936 + j; d[39936 + j] = D[156][j];}
...
for(j = 0; j != D[157].length; ++j) if(D[157][j].charCodeAt(0) !== utf_high_byte) { e[D[157][j]] = 40192 + j; d[40192 + j] = D[157][j];}
...
for(j = 0; j != D[158].length; ++j) if(D[158][j].charCodeAt(0) !== utf_high_byte) { e[D[158][j]] = 40448 + j; d[40448 + j] = D[158][j];}
...
for(j = 0; j != D[159].length; ++j) if(D[159][j].charCodeAt(0) !== utf_high_byte) { e[D[159][j]] = 40704 + j; d[40704 + j] = D[159][j];}
...
for(j = 0; j != D[224].length; ++j) if(D[224][j].charCodeAt(0) !== utf_high_byte) { e[D[224][j]] = 57344 + j; d[57344 + j] = D[224][j];}
...
for(j = 0; j != D[225].length; ++j) if(D[225][j].charCodeAt(0) !== utf_high_byte) { e[D[225][j]] = 57600 + j; d[57600 + j] = D[225][j];}
...
for(j = 0; j != D[226].length; ++j) if(D[226][j].charCodeAt(0) !== utf_high_byte) { e[D[226][j]] = 57856 + j; d[57856 + j] = D[226][j];}
...
for(j = 0; j != D[227].length; ++j) if(D[227][j].charCodeAt(0) !== utf_high_byte) { e[D[227][j]] = 58112 + j; d[58112 + j] = D[227][j];}
...
for(j = 0; j != D[228].length; ++j) if(D[228][j].charCodeAt(0) !== utf_high_byte) { e[D[228][j]] = 58368 + j; d[58368 + j] = D[228][j];}
...
for(j = 0; j != D[229].length; ++j) if(D[229][j].charCodeAt(0) !== utf_high_byte) { e[D[229][j]] = 58624 + j; d[58624 + j] = D[229][j];}
...
for(j = 0; j != D[230].length; ++j) if(D[230][j].charCodeAt(0) !== utf_high_byte) { e[D[230][j]] = 58880 + j; d[58880 + j] = D[230][j];}
...
for(j = 0; j != D[231].length; ++j) if(D[231][j].charCodeAt(0) !== utf_high_byte) { e[D[231][j]] = 59136 + j; d[59136 + j] = D[231][j];}
...
for(j = 0; j != D[232].length; ++j) if(D[232][j].charCodeAt(0) !== utf_high_byte) { e[D[232][j]] = 59392 + j; d[59392 + j] = D[232][j];}
...
for(j = 0; j != D[233].length; ++j) if(D[233][j].charCodeAt(0) !== utf_high_byte) { e[D[233][j]] = 59648 + j; d[59648 + j] = D[233][j];}
D[234] = "����������������������������������������������������������������鵝鵞鵤鵑鵐鵙鵲鶉鶇鶫鵯鵺鶚鶤鶩鶲鷄鷁鶻鶸鶺鷆鷏鷂鷙鷓鷸鷦鷭鷯鷽鸚鸛鸞鹵鹹鹽麁麈麋麌麒麕麑麝麥麩麸麪麭靡黌黎黏黐黔黜點黝黠黥黨黯�黴黶黷黹黻黼黽鼇鼈皷鼕鼡鼬鼾齊齒齔齣齟齠齡齦齧齬齪齷齲齶龕龜龠堯槇遙瑤凜熙�������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[234].length; ++j) if(D[234][j].charCodeAt(0) !== utf_high_byte) { e[D[234][j]] = 59904 + j; d[59904 + j] = D[234][j];}
...
for(j = 0; j != D[237].length; ++j) if(D[237][j].charCodeAt(0) !== utf_high_byte) { e[D[237][j]] = 60672 + j; d[60672 + j] = D[237][j];}
...
for(j = 0; j != D[238].length; ++j) if(D[238][j].charCodeAt(0) !== utf_high_byte) { e[D[238][j]] = 60928 + j; d[60928 + j] = D[238][j];}
...
for(j = 0; j != D[250].length; ++j) if(D[250][j].charCodeAt(0) !== utf_high_byte) { e[D[250][j]] = 64000 + j; d[64000 + j] = D[250][j];}
...
for(j = 0; j != D[251].length; ++j) if(D[251][j].charCodeAt(0) !== utf_high_byte) { e[D[251][j]] = 64256 + j; d[64256 + j] = D[251][j];}
D[252] = "����������������������������������������������������������������髜魵魲鮏鮱鮻鰀鵰鵫鶴鸙黑������������������������������������������������������������������������������������������������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[252].length; ++j) if(D[252][j].charCodeAt(0) !== utf_high_byte) { e[D[252][j]] = 64512 + j; d[64512 + j] = D[252][j];}
return {"enc": e, "dec": d }; })();
cptable[936] = (function(){ var d = [], e = {}, D = [], j;
D[0] = common_chars + "€�������������������������������������������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[0].length; ++j) if(D[0][j].charCodeAt(0) !== utf_high_byte) { e[D[0][j]] = 0 + j; d[0 + j] = D[0][j];}
...
for(j = 0; j != D[133].length; ++j) if(D[133][j].charCodeAt(0) !== utf_high_byte) { e[D[133][j]] = 34048 + j; d[34048 + j] = D[133][j];}
...
for(j = 0; j != D[134].length; ++j) if(D[134][j].charCodeAt(0) !== utf_high_byte) { e[D[134][j]] = 34304 + j; d[34304 + j] = D[134][j];}
...
for(j = 0; j != D[160].length; ++j) if(D[160][j].charCodeAt(0) !== utf_high_byte) { e[D[160][j]] = 40960 + j; d[40960 + j] = D[160][j];}
D[161] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������　、。·ˉˇ¨〃々—～‖…‘’“”〔〕〈〉《》「」『』〖〗【】±×÷∶∧∨∑∏∪∩∈∷√⊥∥∠⌒⊙∫∮≡≌≈∽∝≠≮≯≤≥∞∵∴♂♀°′″℃＄¤￠￡‰§№☆★○●◎◇◆□■△▲※→←↑↓〓�".split("");
for(j = 0; j != D[161].length; ++j) if(D[161][j].charCodeAt(0) !== utf_high_byte) { e[D[161][j]] = 41216 + j; d[41216 + j] = D[161][j];}
D[162] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������ⅰⅱⅲⅳⅴⅵⅶⅷⅸⅹ������⒈⒉⒊⒋⒌⒍⒎⒏⒐⒑⒒⒓⒔⒕⒖⒗⒘⒙⒚⒛⑴⑵⑶⑷⑸⑹⑺⑻⑼⑽⑾⑿⒀⒁⒂⒃⒄⒅⒆⒇①②③④⑤⑥⑦⑧⑨⑩��㈠㈡㈢㈣㈤㈥㈦㈧㈨㈩��ⅠⅡⅢⅣⅤⅥⅦⅧⅨⅩⅪⅫ���".split("");
for(j = 0; j != D[162].length; ++j) if(D[162][j].charCodeAt(0) !== utf_high_byte) { e[D[162][j]] = 41472 + j; d[41472 + j] = D[162][j];}
D[163] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������！＂＃￥％＆＇（）＊＋，－．／０１２３４５６７８９：；＜＝＞？＠ＡＢＣＤＥＦＧＨＩＪＫＬＭＮＯＰＱＲＳＴＵＶＷＸＹＺ［＼］＾＿｀ａｂｃｄｅｆｇｈｉｊｋｌｍｎｏｐｑｒｓｔｕｖｗｘｙｚ｛｜｝￣�".split("");
for(j = 0; j != D[163].length; ++j) if(D[163][j].charCodeAt(0) !== utf_high_byte) { e[D[163][j]] = 41728 + j; d[41728 + j] = D[163][j];}
D[164] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������ぁあぃいぅうぇえぉおかがきぎくぐけげこごさざしじすずせぜそぞただちぢっつづてでとどなにぬねのはばぱひびぴふぶぷへべぺほぼぽまみむめもゃやゅゆょよらりるれろゎわゐゑをん������������".split("");
for(j = 0; j != D[164].length; ++j) if(D[164][j].charCodeAt(0) !== utf_high_byte) { e[D[164][j]] = 41984 + j; d[41984 + j] = D[164][j];}
D[165] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������ァアィイゥウェエォオカガキギクグケゲコゴサザシジスズセゼソゾタダチヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポマミムメモャヤュユョヨラリルレロヮワヰヱヲンヴヵヶ���������".split("");
for(j = 0; j != D[165].length; ++j) if(D[165][j].charCodeAt(0) !== utf_high_byte) { e[D[165][j]] = 42240 + j; d[42240 + j] = D[165][j];}
D[166] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������ΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ��������αβγδεζηθικλμνξοπρστυφχψω�������︵︶︹︺︿﹀︽︾﹁﹂﹃﹄��︻︼︷︸︱�︳︴����������".split("");
for(j = 0; j != D[166].length; ++j) if(D[166][j].charCodeAt(0) !== utf_high_byte) { e[D[166][j]] = 42496 + j; d[42496 + j] = D[166][j];}
D[167] = "�����������������������������������������������������������������������������������������������������������������������������������������������������������������АБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ���������������абвгдеёжзийклмнопрстуфхцчшщъыьэюя��������������".split("");
for(j = 0; j != D[167].length; ++j) if(D[167][j].charCodeAt(0) !== utf_high_byte) { e[D[167][j]] = 42752 + j; d[42752 + j] = D[167][j];}
D[168] = "����������������������������������������������������������������ˊˋ˙–―‥‵℅℉↖↗↘↙∕∟∣≒≦≧⊿═║╒╓╔╕╖╗╘╙╚╛╜╝╞╟╠╡╢╣╤╥╦╧╨╩╪╫╬╭╮╯╰╱╲╳▁▂▃▄▅▆▇�█▉▊▋▌▍▎▏▓▔▕▼▽◢◣◤◥☉⊕〒〝〞�����������āáǎàēéěèīíǐìōóǒòūúǔùǖǘǚǜüêɑ�ńň�ɡ����ㄅㄆㄇㄈㄉㄊㄋㄌㄍㄎㄏㄐㄑㄒㄓㄔㄕㄖㄗㄘㄙㄚㄛㄜㄝㄞㄟㄠㄡㄢㄣㄤㄥㄦㄧㄨㄩ����������������������".split("");
for(j = 0; j != D[168].length; ++j) if(D[168][j].charCodeAt(0) !== utf_high_byte) { e[D[168][j]] = 43008 + j; d[43008 + j] = D[168][j];}
D[169] = "����������������������������������������������������������������〡〢〣〤〥〦〧〨〩㊣㎎㎏㎜㎝㎞㎡㏄㏎㏑㏒㏕︰￢￤�℡㈱�‐���ー゛゜ヽヾ〆ゝゞ﹉﹊﹋﹌﹍﹎﹏﹐﹑﹒﹔﹕﹖﹗﹙﹚﹛﹜﹝﹞﹟﹠﹡�﹢﹣﹤﹥﹦﹨﹩﹪﹫�������������〇�������������─━│┃┄┅┆┇┈┉┊┋┌┍┎┏┐┑┒┓└┕┖┗┘┙┚┛├┝┞┟┠┡┢┣┤┥┦┧┨┩┪┫┬┭┮┯┰┱┲┳┴┵┶┷┸┹┺┻┼┽┾┿╀╁╂╃╄╅╆╇╈╉╊╋����������������".split("");
for(j = 0; j != D[169].length; ++j) if(D[169][j].charCodeAt(0) !== utf_high_byte) { e[D[169][j]] = 43264 + j; d[43264 + j] = D[169][j];}
D[170] = "����������������������������������������������������������������狜狝狟狢狣狤狥狦狧狪狫狵狶狹狽狾狿猀猂猄猅猆猇猈猉猋猌猍猏猐猑猒猔猘猙猚猟猠猣猤猦猧猨猭猯猰猲猳猵猶猺猻猼猽獀獁獂獃獄獅獆獇獈�獉獊獋獌獎獏獑獓獔獕獖獘獙獚獛獜獝獞獟獡獢獣獤獥獦獧獨獩獪獫獮獰獱�����������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[170].length; ++j) if(D[170][j].charCodeAt(0) !== utf_high_byte) { e[D[170][j]] = 43520 + j; d[43520 + j] = D[170][j];}
D[171] = "����������������������������������������������������������������獲獳獴獵獶獷獸獹獺獻獼獽獿玀玁玂玃玅玆玈玊玌玍玏玐玒玓玔玕玗玘玙玚玜玝玞玠玡玣玤玥玦玧玨玪玬玭玱玴玵玶玸玹玼玽玾玿珁珃珄珅珆珇�珋珌珎珒珓珔珕珖珗珘珚珛珜珝珟珡珢珣珤珦珨珪珫珬珮珯珰珱珳珴珵珶珷�����������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[171].length; ++j) if(D[171][j].charCodeAt(0) !== utf_high_byte) { e[D[171][j]] = 43776 + j; d[43776 + j] = D[171][j];}
D[172] = "����������������������������������������������������������������珸珹珺珻珼珽現珿琀琁琂琄琇琈琋琌琍琎琑琒琓琔琕琖琗琘琙琜琝琞琟琠琡琣琤琧琩琫琭琯琱琲琷琸琹琺琻琽琾琿瑀瑂瑃瑄瑅瑆瑇瑈瑉瑊瑋瑌瑍�瑎瑏瑐瑑瑒瑓瑔瑖瑘瑝瑠瑡瑢瑣瑤瑥瑦瑧瑨瑩瑪瑫瑬瑮瑯瑱瑲瑳瑴瑵瑸瑹瑺�����������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[172].length; ++j) if(D[172][j].charCodeAt(0) !== utf_high_byte) { e[D[172][j]] = 44032 + j; d[44032 + j] = D[172][j];}
D[173] = "����������������������������������������������������������������瑻瑼瑽瑿璂璄璅璆璈璉璊璌璍璏璑璒璓璔璕璖璗璘璙璚璛璝璟璠璡璢璣璤璥璦璪璫璬璭璮璯環璱璲璳璴璵璶璷璸璹璻璼璽璾璿瓀瓁瓂瓃瓄瓅瓆瓇�瓈瓉瓊瓋瓌瓍瓎瓏瓐瓑瓓瓔瓕瓖瓗瓘瓙瓚瓛瓝瓟瓡瓥瓧瓨瓩瓪瓫瓬瓭瓰瓱瓲�����������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[173].length; ++j) if(D[173][j].charCodeAt(0) !== utf_high_byte) { e[D[173][j]] = 44288 + j; d[44288 + j] = D[173][j];}
D[174] = "����������������������������������������������������������������瓳瓵瓸瓹瓺瓻瓼瓽瓾甀甁甂甃甅甆甇甈甉甊甋甌甎甐甒甔甕甖甗甛甝甞甠甡產産甤甦甧甪甮甴甶甹甼甽甿畁畂畃畄畆畇畉畊畍畐畑畒畓畕畖畗畘�畝畞畟畠畡畢畣畤畧畨畩畫畬畭畮畯異畱畳畵當畷畺畻畼畽畾疀疁疂疄疅疇�����������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[174].length; ++j) if(D[174][j].charCodeAt(0) !== utf_high_byte) { e[D[174][j]] = 44544 + j; d[44544 + j] = D[174][j];}
D[175] = "����������������������������������������������������������������疈疉疊疌疍疎疐疓疕疘疛疜疞疢疦疧疨疩疪疭疶疷疺疻疿痀痁痆痋痌痎痏痐痑痓痗痙痚痜痝痟痠痡痥痩痬痭痮痯痲痳痵痶痷痸痺痻痽痾瘂瘄瘆瘇�瘈瘉瘋瘍瘎瘏瘑瘒瘓瘔瘖瘚瘜瘝瘞瘡瘣瘧瘨瘬瘮瘯瘱瘲瘶瘷瘹瘺瘻瘽癁療癄�����������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[175].length; ++j) if(D[175][j].charCodeAt(0) !== utf_high_byte) { e[D[175][j]] = 44800 + j; d[44800 + j] = D[175][j];}
...
for(j = 0; j != D[176].length; ++j) if(D[176][j].charCodeAt(0) !== utf_high_byte) { e[D[176][j]] = 45056 + j; d[45056 + j] = D[176][j];}
...
for(j = 0; j != D[177].length; ++j) if(D[177][j].charCodeAt(0) !== utf_high_byte) { e[D[177][j]] = 45312 + j; d[45312 + j] = D[177][j];}
...
for(j = 0; j != D[178].length; ++j) if(D[178][j].charCodeAt(0) !== utf_high_byte) { e[D[178][j]] = 45568 + j; d[45568 + j] = D[178][j];}
...
for(j = 0; j != D[179].length; ++j) if(D[179][j].charCodeAt(0) !== utf_high_byte) { e[D[179][j]] = 45824 + j; d[45824 + j] = D[179][j];}
...
for(j = 0; j != D[180].length; ++j) if(D[180][j].charCodeAt(0) !== utf_high_byte) { e[D[180][j]] = 46080 + j; d[46080 + j] = D[180][j];}
...
for(j = 0; j != D[181].length; ++j) if(D[181][j].charCodeAt(0) !== utf_high_byte) { e[D[181][j]] = 46336 + j; d[46336 + j] = D[181][j];}
...
for(j = 0; j != D[182].length; ++j) if(D[182][j].charCodeAt(0) !== utf_high_byte) { e[D[182][j]] = 46592 + j; d[46592 + j] = D[182][j];}
...
for(j = 0; j != D[183].length; ++j) if(D[183][j].charCodeAt(0) !== utf_high_byte) { e[D[183][j]] = 46848 + j; d[46848 + j] = D[183][j];}
...
for(j = 0; j != D[184].length; ++j) if(D[184][j].charCodeAt(0) !== utf_high_byte) { e[D[184][j]] = 47104 + j; d[47104 + j] = D[184][j];}
...
for(j = 0; j != D[185].length; ++j) if(D[185][j].charCodeAt(0) !== utf_high_byte) { e[D[185][j]] = 47360 + j; d[47360 + j] = D[185][j];}
...
for(j = 0; j != D[186].length; ++j) if(D[186][j].charCodeAt(0) !== utf_high_byte) { e[D[186][j]] = 47616 + j; d[47616 + j] = D[186][j];}
...
for(j = 0; j != D[187].length; ++j) if(D[187][j].charCodeAt(0) !== utf_high_byte) { e[D[187][j]] = 47872 + j; d[47872 + j] = D[187][j];}
...
for(j = 0; j != D[188].length; ++j) if(D[188][j].charCodeAt(0) !== utf_high_byte) { e[D[188][j]] = 48128 + j; d[48128 + j] = D[188][j];}
...
for(j = 0; j != D[189].length; ++j) if(D[189][j].charCodeAt(0) !== utf_high_byte) { e[D[189][j]] = 48384 + j; d[48384 + j] = D[189][j];}
...
for(j = 0; j != D[190].length; ++j) if(D[190][j].charCodeAt(0) !== utf_high_byte) { e[D[190][j]] = 48640 + j; d[48640 + j] = D[190][j];}
...
for(j = 0; j != D[191].length; ++j) if(D[191][j].charCodeAt(0) !== utf_high_byte) { e[D[191][j]] = 48896 + j; d[48896 + j] = D[191][j];}
...
for(j = 0; j != D[192].length; ++j) if(D[192][j].charCodeAt(0) !== utf_high_byte) { e[D[192][j]] = 49152 + j; d[49152 + j] = D[192][j];}
...
for(j = 0; j != D[193].length; ++j) if(D[193][j].charCodeAt(0) !== utf_high_byte) { e[D[193][j]] = 49408 + j; d[49408 + j] = D[193][j];}
...
for(j = 0; j != D[194].length; ++j) if(D[194][j].charCodeAt(0) !== utf_high_byte) { e[D[194][j]] = 49664 + j; d[49664 + j] = D[194][j];}
...
for(j = 0; j != D[195].length; ++j) if(D[195][j].charCodeAt(0) !== utf_high_byte) { e[D[195][j]] = 49920 + j; d[49920 + j] = D[195][j];}
...
for(j = 0; j != D[196].length; ++j) if(D[196][j].charCodeAt(0) !== utf_high_byte) { e[D[196][j]] = 50176 + j; d[50176 + j] = D[196][j];}
...
for(j = 0; j != D[197].length; ++j) if(D[197][j].charCodeAt(0) !== utf_high_byte) { e[D[197][j]] = 50432 + j; d[50432 + j] = D[197][j];}
...
for(j = 0; j != D[198].length; ++j) if(D[198][j].charCodeAt(0) !== utf_high_byte) { e[D[198][j]] = 50688 + j; d[50688 + j] = D[198][j];}
...
for(j = 0; j != D[199].length; ++j) if(D[199][j].charCodeAt(0) !== utf_high_byte) { e[D[199][j]] = 50944 + j; d[50944 + j] = D[199][j];}
...
for(j = 0; j != D[200].length; ++j) if(D[200][j].charCodeAt(0) !== utf_high_byte) { e[D[200][j]] = 51200 + j; d[51200 + j] = D[200][j];}
...
for(j = 0; j != D[201].length; ++j) if(D[201][j].charCodeAt(0) !== utf_high_byte) { e[D[201][j]] = 51456 + j; d[51456 + j] = D[201][j];}
...
for(j = 0; j != D[202].length; ++j) if(D[202][j].charCodeAt(0) !== utf_high_byte) { e[D[202][j]] = 51712 + j; d[51712 + j] = D[202][j];}
...
for(j = 0; j != D[203].length; ++j) if(D[203][j].charCodeAt(0) !== utf_high_byte) { e[D[203][j]] = 51968 + j; d[51968 + j] = D[203][j];}
...
for(j = 0; j != D[204].length; ++j) if(D[204][j].charCodeAt(0) !== utf_high_byte) { e[D[204][j]] = 52224 + j; d[52224 + j] = D[204][j];}
...
for(j = 0; j != D[205].length; ++j) if(D[205][j].charCodeAt(0) !== utf_high_byte) { e[D[205][j]] = 52480 + j; d[52480 + j] = D[205][j];}
...
for(j = 0; j != D[206].length; ++j) if(D[206][j].charCodeAt(0) !== utf_high_byte) { e[D[206][j]] = 52736 + j; d[52736 + j] = D[206][j];}
...
for(j = 0; j != D[207].length; ++j) if(D[207][j].charCodeAt(0) !== utf_high_byte) { e[D[207][j]] = 52992 + j; d[52992 + j] = D[207][j];}
...
for(j = 0; j != D[208].length; ++j) if(D[208][j].charCodeAt(0) !== utf_high_byte) { e[D[208][j]] = 53248 + j; d[53248 + j] = D[208][j];}
...
for(j = 0; j != D[209].length; ++j) if(D[209][j].charCodeAt(0) !== utf_high_byte) { e[D[209][j]] = 53504 + j; d[53504 + j] = D[209][j];}
...
for(j = 0; j != D[210].length; ++j) if(D[210][j].charCodeAt(0) !== utf_high_byte) { e[D[210][j]] = 53760 + j; d[53760 + j] = D[210][j];}
...
for(j = 0; j != D[211].length; ++j) if(D[211][j].charCodeAt(0) !== utf_high_byte) { e[D[211][j]] = 54016 + j; d[54016 + j] = D[211][j];}
...
for(j = 0; j != D[212].length; ++j) if(D[212][j].charCodeAt(0) !== utf_high_byte) { e[D[212][j]] = 54272 + j; d[54272 + j] = D[212][j];}
...
for(j = 0; j != D[213].length; ++j) if(D[213][j].charCodeAt(0) !== utf_high_byte) { e[D[213][j]] = 54528 + j; d[54528 + j] = D[213][j];}
...
for(j = 0; j != D[214].length; ++j) if(D[214][j].charCodeAt(0) !== utf_high_byte) { e[D[214][j]] = 54784 + j; d[54784 + j] = D[214][j];}
...
for(j = 0; j != D[215].length; ++j) if(D[215][j].charCodeAt(0) !== utf_high_byte) { e[D[215][j]] = 55040 + j; d[55040 + j] = D[215][j];}
...
for(j = 0; j != D[216].length; ++j) if(D[216][j].charCodeAt(0) !== utf_high_byte) { e[D[216][j]] = 55296 + j; d[55296 + j] = D[216][j];}
...
for(j = 0; j != D[217].length; ++j) if(D[217][j].charCodeAt(0) !== utf_high_byte) { e[D[217][j]] = 55552 + j; d[55552 + j] = D[217][j];}
...
for(j = 0; j != D[218].length; ++j) if(D[218][j].charCodeAt(0) !== utf_high_byte) { e[D[218][j]] = 55808 + j; d[55808 + j] = D[218][j];}
...
for(j = 0; j != D[219].length; ++j) if(D[219][j].charCodeAt(0) !== utf_high_byte) { e[D[219][j]] = 56064 + j; d[56064 + j] = D[219][j];}
...
for(j = 0; j != D[220].length; ++j) if(D[220][j].charCodeAt(0) !== utf_high_byte) { e[D[220][j]] = 56320 + j; d[56320 + j] = D[220][j];}
...
for(j = 0; j != D[221].length; ++j) if(D[221][j].charCodeAt(0) !== utf_high_byte) { e[D[221][j]] = 56576 + j; d[56576 + j] = D[221][j];}
...
for(j = 0; j != D[222].length; ++j) if(D[222][j].charCodeAt(0) !== utf_high_byte) { e[D[222][j]] = 56832 + j; d[56832 + j] = D[222][j];}
...
for(j = 0; j != D[223].length; ++j) if(D[223][j].charCodeAt(0) !== utf_high_byte) { e[D[223][j]] = 57088 + j; d[57088 + j] = D[223][j];}
...
for(j = 0; j != D[235].length; ++j) if(D[235][j].charCodeAt(0) !== utf_high_byte) { e[D[235][j]] = 60160 + j; d[60160 + j] = D[235][j];}
...
for(j = 0; j != D[236].length; ++j) if(D[236][j].charCodeAt(0) !== utf_high_byte) { e[D[236][j]] = 60416 + j; d[60416 + j] = D[236][j];}
...
for(j = 0; j != D[239].length; ++j) if(D[239][j].charCodeAt(0) !== utf_high_byte) { e[D[239][j]] = 61184 + j; d[61184 + j] = D[239][j];}
...
for(j = 0; j != D[240].length; ++j) if(D[240][j].charCodeAt(0) !== utf_high_byte) { e[D[240][j]] = 61440 + j; d[61440 + j] = D[240][j];}
...
for(j = 0; j != D[241].length; ++j) if(D[241][j].charCodeAt(0) !== utf_high_byte) { e[D[241][j]] = 61696 + j; d[61696 + j] = D[241][j];}
...
for(j = 0; j != D[242].length; ++j) if(D[242][j].charCodeAt(0) !== utf_high_byte) { e[D[242][j]] = 61952 + j; d[61952 + j] = D[242][j];}
...
for(j = 0; j != D[243].length; ++j) if(D[243][j].charCodeAt(0) !== utf_high_byte) { e[D[243][j]] = 62208 + j; d[62208 + j] = D[243][j];}
...
for(j = 0; j != D[244].length; ++j) if(D[244][j].charCodeAt(0) !== utf_high_byte) { e[D[244][j]] = 62464 + j; d[62464 + j] = D[244][j];}
...
for(j = 0; j != D[245].length; ++j) if(D[245][j].charCodeAt(0) !== utf_high_byte) { e[D[245][j]] = 62720 + j; d[62720 + j] = D[245][j];}
...
for(j = 0; j != D[246].length; ++j) if(D[246][j].charCodeAt(0) !== utf_high_byte) { e[D[246][j]] = 62976 + j; d[62976 + j] = D[246][j];}
...
for(j = 0; j != D[247].length; ++j) if(D[247][j].charCodeAt(0) !== utf_high_byte) { e[D[247][j]] = 63232 + j; d[63232 + j] = D[247][j];}
D[248] = "����������������������������������������������������������������鳣鳤鳥鳦鳧鳨鳩鳪鳫鳬鳭鳮鳯鳰鳱鳲鳳鳴鳵鳶鳷鳸鳹鳺鳻鳼鳽鳾鳿鴀鴁鴂鴃鴄鴅鴆鴇鴈鴉鴊鴋鴌鴍鴎鴏鴐鴑鴒鴓鴔鴕鴖鴗鴘鴙鴚鴛鴜鴝鴞鴟鴠鴡�鴢鴣鴤鴥鴦鴧鴨鴩鴪鴫鴬鴭鴮鴯鴰鴱鴲鴳鴴鴵鴶鴷鴸鴹鴺鴻鴼鴽鴾鴿鵀鵁鵂�����������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[248].length; ++j) if(D[248][j].charCodeAt(0) !== utf_high_byte) { e[D[248][j]] = 63488 + j; d[63488 + j] = D[248][j];}
D[249] = "����������������������������������������������������������������鵃鵄鵅鵆鵇鵈鵉鵊鵋鵌鵍鵎鵏鵐鵑鵒鵓鵔鵕鵖鵗鵘鵙鵚鵛鵜鵝鵞鵟鵠鵡鵢鵣鵤鵥鵦鵧鵨鵩鵪鵫鵬鵭鵮鵯鵰鵱鵲鵳鵴鵵鵶鵷鵸鵹鵺鵻鵼鵽鵾鵿鶀鶁�鶂鶃鶄鶅鶆鶇鶈鶉鶊鶋鶌鶍鶎鶏鶐鶑鶒鶓鶔鶕鶖鶗鶘鶙鶚鶛鶜鶝鶞鶟鶠鶡鶢�����������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[249].length; ++j) if(D[249][j].charCodeAt(0) !== utf_high_byte) { e[D[249][j]] = 63744 + j; d[63744 + j] = D[249][j];}
...
for(j = 0; j != D[253].length; ++j) if(D[253][j].charCodeAt(0) !== utf_high_byte) { e[D[253][j]] = 64768 + j; d[64768 + j] = D[253][j];}
D[254] = "����������������������������������������������������������������兀嗀﨎﨏﨑﨓﨔礼﨟蘒﨡﨣﨤﨧﨨﨩��������������������������������������������������������������������������������������������������������������������������������������������������������������������������������".split("");
for(j = 0; j != D[254].length; ++j) if(D[254][j].charCodeAt(0) !== utf_high_byte) { e[D[254][j]] = 65024 + j; d[65024 + j] = D[254][j];}
return {"enc": e, "dec": d }; })();
...
for(j = 0; j != D[249].length; ++j) if(D[249][j].charCodeAt(0) !== utf_high_byte) { e[D[249][j]] = 63744 + j; d[63744 + j] = D[249][j];}
return {"enc": e, "dec": d }; })();
cptable[1250] = (function(){ var d = common_chars + "€�‚�„…†‡�‰Š‹ŚŤŽŹ�‘’“”•–—�™š›śťžź ˇ˘Ł¤Ą¦§¨©Ş«¬­®Ż°±˛ł´µ¶·¸ąş»Ľ˝ľżŔÁÂĂÄĹĆÇČÉĘËĚÍÎĎĐŃŇÓÔŐÖ×ŘŮÚŰÜÝŢßŕáâăäĺćçčéęëěíîďđńňóôőö÷řůúűüýţ˙", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[1251] = (function(){ var d = common_chars + "ЂЃ‚ѓ„…†‡€‰Љ‹ЊЌЋЏђ‘’“”•–—�™љ›њќћџ ЎўЈ¤Ґ¦§Ё©Є«¬­®Ї°±Ііґµ¶·ё№є»јЅѕїАБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯабвгдежзийклмнопрстуфхцчшщъыьэюя", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[1252] = (function(){ var d = common_chars + "€�‚ƒ„…†‡ˆ‰Š‹Œ�Ž��‘’“”•–—˜™š›œ�žŸ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[1253] = (function(){ var d = common_chars + "€�‚ƒ„…†‡�‰�‹�����‘’“”•–—�™�›���� ΅Ά£¤¥¦§¨©�«¬­®―°±²³΄µ¶·ΈΉΊ»Ό½ΎΏΐΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡ�ΣΤΥΦΧΨΩΪΫάέήίΰαβγδεζηθικλμνξοπρςστυφχψωϊϋόύώ�", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[1254] = (function(){ var d = common_chars + "€�‚ƒ„…†‡ˆ‰Š‹Œ����‘’“”•–—˜™š›œ��Ÿ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏĞÑÒÓÔÕÖ×ØÙÚÛÜİŞßàáâãäåæçèéêëìíîïğñòóôõö÷øùúûüışÿ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[1255] = (function(){ var d = common_chars + "€�‚ƒ„…†‡ˆ‰�‹�����‘’“”•–—˜™�›���� ¡¢£₪¥¦§¨©×«¬­®¯°±²³´µ¶·¸¹÷»¼½¾¿ְֱֲֳִֵֶַָֹ�ֻּֽ־ֿ׀ׁׂ׃װױײ׳״�������אבגדהוזחטיךכלםמןנסעףפץצקרשת��‎‏�", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[1256] = (function(){ var d = common_chars + "€پ‚ƒ„…†‡ˆ‰ٹ‹Œچژڈگ‘’“”•–—ک™ڑ›œ‌‍ں ،¢£¤¥¦§¨©ھ«¬­®¯°±²³´µ¶·¸¹؛»¼½¾؟ہءآأؤإئابةتثجحخدذرزسشصض×طظعغـفقكàلâمنهوçèéêëىيîïًٌٍَôُِ÷ّùْûü‎‏ے", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[1257] = (function(){ var d = common_chars + "€�‚�„…†‡�‰�‹�¨ˇ¸�‘’“”•–—�™�›�¯˛� �¢£¤�¦§Ø©Ŗ«¬­®Æ°±²³´µ¶·ø¹ŗ»¼½¾æĄĮĀĆÄÅĘĒČÉŹĖĢĶĪĻŠŃŅÓŌÕÖ×ŲŁŚŪÜŻŽßąįāćäåęēčéźėģķīļšńņóōõö÷ųłśūüżž˙", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[1258] = (function(){ var d = common_chars + "€�‚ƒ„…†‡ˆ‰�‹Œ����‘’“”•–—˜™�›œ��Ÿ ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂĂÄÅÆÇÈÉÊË̀ÍÎÏĐÑ̉ÓÔƠÖ×ØÙÚÛÜỮßàáâăäåæçèéêë́íîïđṇ̃óôơö÷øùúûüư₫ÿ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[10000] = (function(){ var d = common_chars + "ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤‹›ﬁﬂ‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[10006] = (function(){ var d = common_chars + "Ä¹²É³ÖÜ΅àâä΄¨çéèêë£™îï•½‰ôö¦­ùûü†ΓΔΘΛΞΠß®©ΣΪ§≠°·Α±≤≥¥ΒΕΖΗΙΚΜΦΫΨΩάΝ¬ΟΡ≈Τ«»… ΥΧΆΈœ–―“”‘’÷ΉΊΌΎέήίόΏύαβψδεφγηιξκλμνοπώρστθωςχυζϊϋΐΰ�", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[10007] = (function(){ var d = common_chars + "АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ†°¢£§•¶І®©™Ђђ≠Ѓѓ∞±≤≥іµ∂ЈЄєЇїЉљЊњјЅ¬√ƒ≈∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёяабвгдежзийклмнопрстуфхцчшщъыьэю¤", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
...
for(j = 0; j != D[247].length; ++j) if(D[247][j].charCodeAt(0) !== utf_high_byte) { e[D[247][j]] = 63232 + j; d[63232 + j] = D[247][j];}
return {"enc": e, "dec": d }; })();
cptable[10029] = (function(){ var d = common_chars + "ÄĀāÉĄÖÜáąČäčĆćéŹźĎíďĒēĖóėôöõúĚěü†°Ę£§•¶ß®©™ę¨≠ģĮįĪ≤≥īĶ∂∑łĻļĽľĹĺŅņŃ¬√ńŇ∆«»… ňŐÕőŌ–—“”‘’÷◊ōŔŕŘ‹›řŖŗŠ‚„šŚśÁŤťÍŽžŪÓÔūŮÚůŰűŲųÝýķŻŁżĢˇ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[10079] = (function(){ var d = common_chars + "ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûüÝ°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸ⁄¤ÐðÞþý·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙıˆ˜¯˘˙˚¸˝˛ˇ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[10081] = (function(){ var d = common_chars + "ÄÅÇÉÑÖÜáàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™´¨≠ÆØ∞±≤≥¥µ∂∑∏π∫ªºΩæø¿¡¬√ƒ≈∆«»… ÀÃÕŒœ–—“”‘’÷◊ÿŸĞğİıŞş‡·‚„‰ÂÊÁËÈÍÎÏÌÓÔ�ÒÚÛÙ�ˆ˜¯˘˙˚¸˝˛ˇ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
cptable[28591] = (function(){ var d = common_chars + " ¡¢£¤¥¦§¨©ª«¬­®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ", D = [], e = {}; for(var i=0;i!=d.length;++i) { if(d.charCodeAt(i) !== utf_high_byte) e[d.charAt(i)] = i; D[i] = d.charAt(i); } return {"enc": e, "dec": D }; })();
    ...
    if(C && (D=C.dec)) {
      ...
      case "utf8":
        ...
        for(; i < len; i+=j) {
          ...
          if(w < 65536) { out[k++] = sfcc(w); }
          else {
            w -= 65536; ww = 0xD800 + ((w>>10)&1023); w = 0xDC00 + (w&1023);
            out[k++] = sfcc(ww); out[k++] = sfcc(w);
          }
        }
        break;
      case "ascii":
        if(has_buf && Buffer.isBuffer(data)) return data.toString(M);
        for(i = 0; i < len; i++) out[i] = sfcc(data[i]);
        k = len; break;
      case "utf16le":
      ...
      case "utf32le":
        ...
        for(; i < len; i+=j) {
          ...
          if(w > 0xFFFF) {
            w -= 0x10000;
            out[k++] = sfcc(0xD800 + ((w >> 10) & 0x3FF));
            out[k++] = sfcc(0xDC00 + (w & 0x3FF));
          }
          else out[k++] = sfcc(w);
        }
        break;
      ...
      case "utf7":
        ...
        for(; i < len; i+=j) {
          if(data[i] !== 0x2b) { j=1; out[k++] = sfcc(data[i]); continue; }
          j=1;
          if(data[i+1] === 0x2d) { j = 2; out[k++] = "+"; continue; }
          // eslint-disable-next-line no-useless-escape
          while(sfcc(data[i+j]).match(/[A-Za-z0-9+\/]/)) j++;
          var dash = 0;
          ...
          for(var l = 1; l < j - dash;) {
            e1 = BM.indexOf(sfcc(data[i+l++]));
            e2 = BM.indexOf(sfcc(data[i+l++]));
            c1 = e1 << 2 | e2 >> 4;
            tt.push(c1);
            e3 = BM.indexOf(sfcc(data[i+l++]));
            if(e3 === -1) break;
            c2 = (e2 & 15) << 4 | e3 >> 2;
            tt.push(c2);
            e4 = BM.indexOf(sfcc(data[i+l++]));
            if(e4 === -1) break;
            c3 = (e3 & 3) << 6 | e4;
            if(e4 < 64) tt.push(c3);
          }
